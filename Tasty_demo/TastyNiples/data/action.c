Action()
{
	...
	web_custom_request("ocsp.r2m02.amazontrust.com_3", 
		"URL=http://ocsp.r2m02.amazontrust.com/", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/ocsp-response", 
	...
	web_custom_request("ocsp.r2m02.amazontrust.com_4", 
		"URL=http://ocsp.r2m02.amazontrust.com/", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/ocsp-response", 
	...
	web_url("configs_2", 
		...
		"", 
		"Snapshot=t67.inf", 
		"Mode=HTML", 
		LAST);

	web_url("preferences", 
		"URL=https://api.razorpay.com/v1/standard_checkout/preferences?session_token=&currency%5B0%5D=INR&_%5Bpreference_source%5D=checkout_frame_standard_lite&_%5Bbuild%5D=7974256659&_%5Blibrary%5D=checkoutjs&"
	...
	web_submit_data("account_2", 
		...
		"Name=customer[first_name]", "Value=Maria", ENDITEM, 
		"Name=customer[last_name]", "Value=Augustine", ENDITEM, 
		"Name=customer[email]", "Value=maria@gmail.com", ENDITEM, 
		"Name=customer[password]", "Value=maria@123", ENDITEM, 
		LAST);
