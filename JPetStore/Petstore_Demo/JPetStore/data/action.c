Action()
{
	...
	web_submit_data("Catalog.action;jsessionid=4BEC92598A768F7B356BFE56BE7E86AA", 
		"Action=https://petstore.octoperf.com/actions/Catalog.action;jsessionid=4BEC92598A768F7B356BFE56BE7E86AA", 
		"Method=POST", 
		"RecContentType=text/html", 
		...
		"Name=_sourcePage", "Value=ArdhTtNCIBLEMLpxK_buctD2FWX0evwiNDJZ6xTC9HzfaY42erA1A5TkB5DnBG7401N5-0ItILikiBqi3lo6Prwr_DxRJ5nM", ENDITEM, 
		"Name=__fp", "Value=85JeGvUCQ_gj7HO7Zj5sBY_NqAx0XFzsZ6iejuZ8-PhyxqddS8pIrsWK8uS-JbVh", ENDITEM, 
		LAST);
